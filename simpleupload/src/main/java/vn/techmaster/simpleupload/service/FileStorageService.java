...
public class FileStorageService {
    ...
    public String storeFile(MultipartFile file, String fileDescription) {
        // Normalize file name
        ...
        try {
            ...
            UploadFileResponse newImage = new UploadFileResponse ();
            newImage.setFileName(fileName);
            newImage.setFileDescription(fileDescription);
            newImage.setFileDownloadUri(ServletUriComponentsBuilder.fromCurrentContextPath().path(fileName).toUriString());
                    
            uploadRepository.save(newImage);
